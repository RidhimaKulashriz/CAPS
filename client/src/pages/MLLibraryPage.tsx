...
export default function MLLibraryPage() {
  ...
  return <main className="page-shell">
    ...
    <div className="page-heading"><div><div className="eyebrow">KNOWLEDGE LIBRARY</div><h1>ML library</h1><p>Short, real ML and scientific-network clips bundled for reliable direct playback inside CaPS.</p></div><b className="big-count">3<small>local clips</small></b></div>
